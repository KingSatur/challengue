...
public class BeanConfiguration {
	...
	BibliotecService bibliotecService(final BibliotecRepository bibliotecRepository,
			final BookRepository bookRepository, final ItemBookRepository itemBookRepository) {
		return new BibliotecServiceImpl(bibliotecRepository, bookRepository, itemBookRepository);
	}
